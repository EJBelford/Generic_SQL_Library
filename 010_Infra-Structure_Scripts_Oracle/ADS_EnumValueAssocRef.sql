...
-- 2018-05-15 - euGene Belford  -             - Created 
--
/*--*----1----*----2----*----3----*----4----*----5----*----6----*----7----*---*/

/*----- 170_Sequence  -----*/

DROP SEQUENCE authDataSource_dev.enumValueAssocRef_seq;

CREATE SEQUENCE authDataSource_dev.enumValueAssocRef_seq
--    START WITH 1000000 
    MINVALUE   1
    NOCYCLE
    NOCACHE
...
DROP TABLE authDataSource_dev.enumValueAssocRef CASCADE CONSTRAINTS;
	
CREATE TABLE authDataSource_dev.enumValueAssocRef 
(
...
TABLESPACE AuthDataSrc_Dev_TabSpace;

/*----- Table Meta-Data -----*/ 

COMMENT ON TABLE authDataSource_dev.enumValueAssocRef 
...
COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.rec_id 
IS 'REC_ID - Primary, blind key of the enum_value_assocs table.'; 
COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.rec_uuid 
IS 'REC_UUID - Blind uuid key of the enum_value_assocs table.'; 

COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.enum_type 
IS 'enum_type - Name/identifier of the overarching enumeration type that this value belongs to.  ';
COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.enum_assoc_type 
IS 'enum_assoc_type -  ';
COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.enum_assoc_name 
IS 'enum_assoc_name -  ';
COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.enum_assoc_desc 
IS 'enum_assoc_desc - Brief description of the enumeration association value.  ';	
COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.enum_value_rec_id 
IS 'enum_value_rec_id -  ';
COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.enum_value_rec_uuid 
IS 'enum_value_rec_uuid -  ';

COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.status 
...
COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.updt_by 
IS 'UPDT_BY - The date/timestamp of when the record was created/updated.';
COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.lst_updt 
IS 'LST_UPDT - Indicates either the program name or user ID of the person who updated the record.';
COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.active_flag 
IS 'ACTIVE_FLAG - Flag indicating if the record is active or not.';
COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.active_date 
IS 'ACTIVE_DATE - Additional control for active_Fl indicating when the record became active.';
COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.inactive_date 
IS 'INACTIVE_DATE - Additional control for active_Fl indicating when the record went inactive.';
COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.insert_by 
IS 'INSERT_BY - Reports who initially created the record.';
COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.insert_date 
IS 'INSERT_DATE - Reports when the record was initially created.';
COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.update_by 
IS 'UPDATE_BY - Reports who last updated the record.';
COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.update_date 
IS 'UPDATE_DATE - Reports when the record was last updated.';
COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.delete_by 
IS 'DELETE_BY - Reports who last deleted the record.';       
COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.delete_flag 
IS 'DELETE_FLAG - Flag indicating if the record can be deleted.';
COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.delete_date 
IS 'DELETE_DATE - Additional control for DELETE_FLAG indicating when the record was marked for deletion.';
COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.hidden_by 
IS 'HIDDEN_BY - Reports who last hide the record.';       
COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.hidden_flag 
IS 'HIDDEN_FLAG - Flag indicating if the record should be hidden from the general user in things like drop-down lists.';
COMMENT ON COLUMN authDataSource_dev.enumValueAssocRef.hidden_date 
...
ALTER TABLE authDataSource_dev.enumValueAssocRef  
...
CREATE UNIQUE INDEX authDataSource_dev.ixu_enumValueAssocRef 
...
ALTER TABLE authDataSource_dev.enumValueAssocRef  
    ...
    REFERENCES authDataSource_dev.enumTypeRef
        (
        enum_type
        ); 
...
ALTER TABLE enumValueAssocRef  
    ...
    REFERENCES authDataSource_dev.enumValueRef
        (
        rec_id
        ); 
...
BEFORE INSERT
ON authDataSource_dev.EnumValueAssocRef
...
----*----|----*----|----*----|----*----|----*----|----*----|----*----|----*---*/
--
--         NAME:            _grant_enumValueAssocRef
--      PURPOSE: Create grants for enumValueAssocRef
--
--   CREATED BY: euGene Belford
-- CREATED DATE: 2018-05-15
--
--       SOURCE:            _grant_enumValueAssocRef.sql
--
--        NOTES:
-- 
/*--*----|----*----|----*----|----*----|----*----|----*----|----*----|----*---*/
...
GRANT SELECT, INSERT, UPDATE         ON enumValueAssocRef TO eps_admin;
GRANT SELECT                         ON enumValueAssocRef TO eps_user;
...
----*----|----*----|----*----|----*----|----*----|----*----|----*----|----*---*/
--
--         NAME:            _synonym_enumValueAssocRef
--      PURPOSE: Create synonyn for enum_value_assocs
--
--   CREATED BY: euGene Belford
-- CREATED DATE: 2018-05-15
--
--       SOURCE:            _synonym_enumValueAssocRef.sql
--
--        NOTES:
--
-- 
...
----*----|----*----|----*----|----*----|----*----|----*----|----*----|----*---*/
--
--         NAME:            _merge_enum_value_assocs
--      PURPOSE: Inital load script for enum_value_assocs
--
--   CREATED BY: euGene Belford
-- CREATED DATE: 2018-05-15
--
--       SOURCE:            x_merge_enumValueAssocRef.sql
--
--        NOTES:
--
-- 
