...
--
--         NAME: enum_value_seq
--      PURPOSE: REC_ID sequence for enum_values
--
--   CREATED BY: Gene Belford
-- CREATED DATE: 2018-05-10
--
--       SOURCE: enum_value_seq.sql
--
--        NOTES:
--
-- 
...
--
    ...
    enum_display_name                VARCHAR2(125)       NOT NULL ,
    description                      VARCHAR2(2000) ,	
    constant_flag                    CHAR(1)             DEFAULT 'N' ,
    enum_type_rec_id                 NUMBER              NOT NULL ,
    enum_type_rec_uuid               VARCHAR2(40)        NOT NULL ,
--
...
COMMENT ON TABLE enum_value_ref 
IS 'enum_values - Individual enumeration values that belong under a particular enumeration type.'; 


/*----- Column Meta-Data -----*/ 

COMMENT ON COLUMN enum_value_ref.rec_id 
IS 'REC_ID - Primary, blind key of the enum_values table.'; 
COMMENT ON COLUMN enum_value_ref.rec_uuid 
IS 'REC_UUID - Blind uuid key of the enum_values table.'; 

COMMENT ON COLUMN enum_value_ref.enum_type 
IS 'enum_type - Name/identifier of the overarching enumeration type that this value belongs to.  ';
COMMENT ON COLUMN enum_value_ref.enum_value 
IS 'enum_value - The actual specific enumeration value.  ';
COMMENT ON COLUMN enum_value_ref.order_by 
IS 'order_by - Integer value used to create a custom sort order not possible programmatically.  ';
COMMENT ON COLUMN enum_value_ref.enum_display_name 
IS 'enum_display_name - ';
COMMENT ON COLUMN enum_value_ref.description 
IS 'description - Brief description of the enumeration value.  ';	
COMMENT ON COLUMN enum_value_ref.constant_flag 
IS 'constant - Whether or not enumeration value is unchangeable or dynamic.  ';
COMMENT ON COLUMN enum_value_ref.enum_type_rec_id 
IS 'enum_type_rec_id -  ';
COMMENT ON COLUMN enum_value_ref.enum_type_rec_uuid 
IS 'enum_type_rec_uuid -  ';


COMMENT ON COLUMN enum_value_ref.status 
...
COMMENT ON COLUMN enum_value_ref.updt_by 
IS 'UPDT_BY - The date/timestamp of when the record was created/updated.';
COMMENT ON COLUMN enum_value_ref.lst_updt 
IS 'LST_UPDT - Indicates either the program name or user ID of the person who updated the record.';
COMMENT ON COLUMN enum_value_ref.active_flag 
IS 'ACTIVE_FLAG - Flag indicating if the record is active or not.';
COMMENT ON COLUMN enum_value_ref.active_date 
IS 'ACTIVE_DATE - Additional control for active_Fl indicating when the record became active.';
COMMENT ON COLUMN enum_value_ref.inactive_date 
IS 'INACTIVE_DATE - Additional control for active_Fl indicating when the record went inactive.';
COMMENT ON COLUMN enum_value_ref.insert_by 
IS 'INSERT_BY - Reports who initially created the record.';
COMMENT ON COLUMN enum_value_ref.insert_date 
IS 'INSERT_DATE - Reports when the record was initially created.';
COMMENT ON COLUMN enum_value_ref.update_by 
IS 'UPDATE_BY - Reports who last updated the record.';
COMMENT ON COLUMN enum_value_ref.update_date 
IS 'UPDATE_DATE - Reports when the record was last updated.';
COMMENT ON COLUMN enum_value_ref.delete_by 
IS 'DELETE_BY - Reports who last deleted the record.';       
COMMENT ON COLUMN enum_value_ref.delete_flag 
IS 'DELETE_FLAG - Flag indicating if the record can be deleted.';
COMMENT ON COLUMN enum_value_ref.delete_date 
IS 'DELETE_DATE - Additional control for DELETE_FLAG indicating when the record was marked for deletion.';
COMMENT ON COLUMN enum_value_ref.hidden_by 
IS 'HIDDEN_BY - Reports who last hide the record.';       
COMMENT ON COLUMN enum_value_ref.hidden_flag 
IS 'HIDDEN_FLAG - Flag indicating if the record should be hidden from the general user in things like drop-down lists.';
COMMENT ON COLUMN enum_value_ref.hidden_date 
...
WHERE  table_name = UPPER('enum_value_ref'); 
*/
...
LEFT OUTER JOIN user_tab_columns b ON b.table_name = UPPER('enum_value_ref') 
    AND  a.column_name = b.column_name
WHERE    a.table_name = UPPER('enum_value_ref') 
...
--
--         NAME: enum_value_ref
--      PURPOSE: Primary key for enum_values
--
--   CREATED BY: Gene Belford
-- CREATED DATE: 2018-05-10
--
...
--
--         NAME: enum_value_ref
--      PURPOSE: Unique index for ixu_enum_values
--
--   CREATED BY: Gene Belford
-- CREATED DATE: 2018-05-10
--
...
-- DROP INDEX ixu_enum_value_ref;

CREATE UNIQUE INDEX ixu_enum_value_ref 
    ON enum_value_ref
        (
        enum_type, 
		enum_value
...
--
--         NAME: enum_value_ref
--      PURPOSE: Foreign key for fk_enum_values_xx_id..
--
--   CREATED BY: Gene Belford
-- CREATED DATE: 2018-05-10
--
...
ALTER TABLE enum_value_ref  DROP CONSTRAINT fk_enum_value_ref_enum_type;        

ALTER TABLE enum_value_ref  
    ADD CONSTRAINT fk_enum_value_ref_enum_type 
    FOREIGN KEY 
        (
        enum_type
        ) 
...
ALTER TABLE enum_value_ref  DROP CONSTRAINT fk_enumvalueref_enumtyperecid;        

ALTER TABLE enum_value_ref  
    ADD CONSTRAINT fk_enumvalueref_enumtyperecid 
    FOREIGN KEY 
        (
        enum_type_rec_id
        ) 
...
ALTER TABLE enum_value_ref  DROP CONSTRAINT fk_enumvalueref_enumtypeuuid;        

ALTER TABLE enum_value_ref  
    ADD CONSTRAINT fk_enumvalueref_enumtypeuuid 
    FOREIGN KEY 
        (
        enum_type_rec_uuid
        ) 
...
--
--         NAME: enum_value_ref
--      PURPOSE: Create the active_flag constraint for enum_values
--
--   CREATED BY: Gene Belford
-- CREATED DATE: 2018-05-10
--
--       SOURCE: ck_enum_values_act_fl.sql
-- 
/*--*----|----*----|----*----|----*----|----*----|----*----|----*----|----*---*/
-- CHANGE HISTORY
-- YYYY-MM-DD - Who         - RDP / ECP # - Details..
...
-- ALTER TABLE enum_values  DROP CONSTRAINT ck_enum_values_act_fl; 
...
--
--         NAME: enum_value_ref
--      PURPOSE: Create the delete_flag constraint for enum_values
--
--   CREATED BY: Gene Belford
-- CREATED DATE: 2018-05-10
--
...
-- ALTER TABLE enum_values  DROP CONSTRAINT ck_enum_values_del_fl;    
...
--
--         NAME: enum_value_ref
--      PURPOSE: Create the hidden_flag constraint for enum_values
--
--   CREATED BY: Gene Belford
-- CREATED DATE: 2018-05-10
--
...
-- ALTER TABLE enum_values  DROP CONSTRAINT ck_enum_value_ref_hid_fl;  
...
--
--         NAME: enum_value_ref
--      PURPOSE: Create the status constraint for enum_values
--
--   CREATED BY: Gene Belford
-- CREATED DATE: 2018-05-10
--
...
CREATE OR REPLACE TRIGGER tr_i_enum_value_ref_seq
BEFORE INSERT
ON "EnumValueRef"
...
--      PURPOSE: Create synonyn for enum_values
--
--   CREATED BY: Gene Belford
-- CREATED DATE: 2018-05-10
--
...
--CREATE PUBLIC SYNONYM enum_value_ref 
--FOR "PDS".enum_value_ref; 
...
----*----|----*----|----*----|----*----|----*----|----*----|----*----|----*---*/
--
--         NAME: xxxTSK00xxx_merge_enum_values
--      PURPOSE: Inital load script for enum_values
--
--   CREATED BY: Gene Belford
-- CREATED DATE: 2018-05-10
--
