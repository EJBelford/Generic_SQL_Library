...
--                                          Initial Creation.
-- =======================================================================
procedure %YourObjectName%( p_Name in type, p_Name out nocopy type, p_Name in out nocopy type ) is
    DiagLogging         boolean;
...
--    when e??? then
--        -- Error string here.
--        -- Temporary, until the RPA_APPLICATION_MESSAGE package gets deployed.
