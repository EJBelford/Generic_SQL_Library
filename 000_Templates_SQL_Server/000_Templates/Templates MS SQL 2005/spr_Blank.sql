...
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[xxx_sp]') 
...
EXEC	RptToCourt_ProcessLog_Entry_sp 
		@ProcessRecId OUTPUT, 0, @ProcessKey, @ProcessStartDt --, @ProcessEndDt, @ProcessStatusCd, @SqlErrorCode,
...
EXEC	RptToCourt_ProcessLog_Entry_sp 
		@ProcessRecId, 0, @ProcessKey, @ProcessStartDt, @ProcessEndDt, @ProcessStatusCd, @SqlErrorCode,
		@RecReadInt, @RecValidInt, @RecLoadInt, 
		@RecInsertedInt, @RecSelectedInt, @RecUpdatedInt, @RecDeletedInt,
		@UserLoginId, @Message 
