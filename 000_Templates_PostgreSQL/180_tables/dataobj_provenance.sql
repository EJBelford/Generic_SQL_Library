/* Source File: dataobj_provenance.sql                                        */
/*--+----1----+----2----+----3----+----4----+----5----+----6----+----7----+---*/
/*                                                                            */
/* Module Name: dataobj_provenance                                            */
/*      Author: Gene Belford                                                  */
/* Description: This table is about collecting information about the          */
/*              entities, activities, and people invloved in producing a      */
/*              piece of data or thing, which can be used to form assessments */
...
-- DROP TABLE IF EXISTS dataobj_provenance;

CREATE TABLE dataobj_provenance 
(
rec_id                INTEGER      NOT NULL DEFAULT nextval('dataobj_provenance_seq'::regclass),
--
rec_uuid              UUID         NOT NULL DEFAULT uuid_generate_v4(), 
dataobj_rec_uuid      UUID         NOT NULL, 
--
provenance_cd         VARCHAR(24)  NOT NULL, 
prov_who              VARCHAR(50)  DEFAULT USER,
was_generated_by      VARCHAR(50)  NOT NULL, 
act_on_behalf_of      VARCHAR(50), 
was_attributed_to     VARCHAR(50), 
prov_what             VARCHAR(50), 
was_derived_from      VARCHAR(50), 
prov_when             TIMESTAMP WITH TIME ZONE  NOT NULL, 
prov_where            VARCHAR(50), 
prov_how              VARCHAR(50), 
prov_why              VARCHAR(50), 
provenance_comment    VARCHAR(50), 
was_associated_wtih   VARCHAR(50), 
was_informed_by       VARCHAR(50), 
was_used_by           VARCHAR(50), 
--
...
COMMENT ON TABLE dataobj_provenance 
IS 'dataobj_provenance - This table is about collecting information about the entities, activities, and people invloved in producing a piece of data or thing, which can be used to form assessments about its quality, reliability or trustworthiness.';

COMMENT ON COLUMN dataobj_provenance.rec_id 
...
--COMMENT ON COLUMN dataobj_provenance.dataobj_provenance_nm 
--IS '<fieldName> - ';
--COMMENT ON COLUMN dataobj_provenance.dataobj_provenance_desc 
--IS '<fieldDesc> - ';

COMMENT ON COLUMN dataobj_provenance.status 
...
COMMENT ON COLUMN dataobj_provenance.mandatorymetadata_security_c_2 
...
COMMENT ON COLUMN dataobj_provenance.mandatorymetadata_security_c_1 
...
COMMENT ON COLUMN dataobj_provenance.mandatorymetadata_security_d_7 
...
COMMENT ON COLUMN dataobj_provenance.mandatorymetadata_security_d_6 
...
COMMENT ON COLUMN dataobj_provenance.mandatorymetadata_security_d_3 
...
COMMENT ON COLUMN dataobj_provenance.mandatorymetadata_security_d_4 
...
COMMENT ON COLUMN dataobj_provenance.mandatorymetadata_security_d_5 
...
COMMENT ON COLUMN dataobj_provenance.mandatorymetadata_security_d_1 
...
COMMENT ON COLUMN dataobj_provenance.mandatorymetadata_security_d_2 
...
COMMENT ON COLUMN dataobj_provenance.mandatorymetadata_security_d_0 
...
COMMENT ON COLUMN dataobj_provenance.mandatorymetadata_security_f_0 
...
COMMENT ON COLUMN dataobj_provenance.mandatorymetadata_security_f_1 
...
COMMENT ON COLUMN dataobj_provenance.mandatorymetadata_security_n_0 
...
COMMENT ON COLUMN dataobj_provenance.mandatorymetadata_security_o_0 
...
COMMENT ON COLUMN dataobj_provenance.mandatorymetadata_security_r_0 
...
COMMENT ON COLUMN dataobj_provenance.mandatorymetadata_security_s_1 
...
COMMENT ON COLUMN dataobj_provenance.mandatorymetadata_security_s_0 
...
COMMENT ON COLUMN dataobj_provenance.mandatorymetadata_security_t_0 
...
WHERE pc.relname = LOWER('dataobj_provenance') AND pn.nspname = 'public';
*/
