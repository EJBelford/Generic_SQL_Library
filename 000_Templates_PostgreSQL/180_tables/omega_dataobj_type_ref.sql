/* Source File: omega_dataobj_type_ref.sql                                    */
/*--+----1----+----2----+----3----+----4----+----5----+----6----+----7----+---*/
/*                                                                            */
/* Module Name: omega_dataobj_type_ref                                        */
/*      Author: Gene Belford                                                  */
/* Description: This table contains the reference code for the OMEGA          */
/*              dataobject types.                                             */
/*        Date: 2014-01-29                                                    */
/*                                                                            */
/*--+----1----+----2----+----3----+----4----+----5----+----6----+----7----+---*/
...
-- DROP TABLE IF EXISTS omega_dataobj_type_ref;

CREATE TABLE omega_dataobj_type_ref 
(
rec_id                 INTEGER      NOT NULL DEFAULT nextval('omega_dataobj_type_ref_seq'::regclass),
--
rec_uuid               UUID         NOT NULL DEFAULT uuid_generate_v4(), 
--
dataobj_type_cd        INTEGER      UNIQUE NOT NULL,
dataobj_type_nm        VARCHAR(50)  UNIQUE NOT NULL,
dataobj_type_desc      VARCHAR(50)  NOT NULL, 
--
...
COMMENT ON TABLE omega_dataobj_type_ref 
IS 'omega_dataobj_type_ref - This table contains the reference code for the OMEGA dataobject types.';

COMMENT ON COLUMN omega_dataobj_type_ref.rec_id 
...
COMMENT ON COLUMN omega_dataobj_type_ref.dataobj_type_cd 
IS 'dataobj_cd - ';
COMMENT ON COLUMN omega_dataobj_type_ref.dataobj_type_nm 
IS 'dataobj_type - ';
COMMENT ON COLUMN omega_dataobj_type_ref.dataobj_type_desc 
IS 'dataobj_type - ';

COMMENT ON COLUMN omega_dataobj_type_ref.status 
...
COMMENT ON COLUMN omega_dataobj_type_ref.mandatorymetadata_security_c_2 
...
COMMENT ON COLUMN omega_dataobj_type_ref.mandatorymetadata_security_c_1 
...
COMMENT ON COLUMN omega_dataobj_type_ref.mandatorymetadata_security_d_7 
...
COMMENT ON COLUMN omega_dataobj_type_ref.mandatorymetadata_security_d_6 
...
COMMENT ON COLUMN omega_dataobj_type_ref.mandatorymetadata_security_d_3 
...
COMMENT ON COLUMN omega_dataobj_type_ref.mandatorymetadata_security_d_4 
...
COMMENT ON COLUMN omega_dataobj_type_ref.mandatorymetadata_security_d_5 
...
COMMENT ON COLUMN omega_dataobj_type_ref.mandatorymetadata_security_d_1 
...
COMMENT ON COLUMN omega_dataobj_type_ref.mandatorymetadata_security_d_2 
...
COMMENT ON COLUMN omega_dataobj_type_ref.mandatorymetadata_security_d_0 
...
COMMENT ON COLUMN omega_dataobj_type_ref.mandatorymetadata_security_f_0 
...
COMMENT ON COLUMN omega_dataobj_type_ref.mandatorymetadata_security_f_1 
...
COMMENT ON COLUMN omega_dataobj_type_ref.mandatorymetadata_security_n_0 
...
COMMENT ON COLUMN omega_dataobj_type_ref.mandatorymetadata_security_o_0 
...
COMMENT ON COLUMN omega_dataobj_type_ref.mandatorymetadata_security_r_0 
...
COMMENT ON COLUMN omega_dataobj_type_ref.mandatorymetadata_security_s_1 
...
COMMENT ON COLUMN omega_dataobj_type_ref.mandatorymetadata_security_s_0 
...
COMMENT ON COLUMN omega_dataobj_type_ref.mandatorymetadata_security_t_0 
...
WHERE pc.relname = LOWER('omega_dataobj_type_ref') AND pn.nspname = 'public';
*/
