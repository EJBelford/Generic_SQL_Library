/* Source File: omega_batch_tasks.sql                                         */
/*--+----1----+----2----+----3----+----4----+----5----+----6----+----7----+---*/
/*                                                                            */
/* Module Name: omega_batch_tasks                                             */
/*      Author: Gene Belford                                                  */
/* Description: This table tasks under the batch job.                         */
/*        Date: 2014-02-27                                                    */
/*                                                                            */
/*--+----1----+----2----+----3----+----4----+----5----+----6----+----7----+---*/
/*                                                                            */
...
-- DROP TABLE IF EXISTS omega_batch_tasks;

CREATE TABLE omega_batch_tasks 
(
rec_id                         INTEGER      NOT NULL DEFAULT nextval('omega_batch_tasks_seq'::regclass),
--
rec_uuid                       UUID         NOT NULL DEFAULT uuid_generate_v4(), 
--
batch_que_uuid                 UUID         NOT NULL,
agent                          UUID, 
task_nm                        VARCHAR(255), 
entity_src_uuid                UUID         NOT NULL, 
activity                       UUID, 
activity_parameters_uuid       UUID, 
entity_derived_uuid            UUID         NOT NULL, 
--
task_status                    CHAR(2)      NOT NULL,
task_prct_cmplt                INTEGER,
task_error_cnt                 INTEGER,
task_start_datetime            TIMESTAMP WITH TIME ZONE,
task_stop_datetime             TIMESTAMP WITH TIME ZONE,
task_message                   VARCHAR(200),
user_remarks                   VARCHAR(200), 
--
...
COMMENT ON TABLE omega_batch_tasks 
IS 'omega_batch_tasks - This table tasks under the batch job. ';

COMMENT ON COLUMN omega_batch_tasks.rec_id 
IS 'rec_id - The unquie durable single field key assigned to the record.';
COMMENT ON COLUMN omega_process_log.rec_uuid 
IS 'rec_uuid - Stores the Universally Uni IDentifier (UUID) as defined by RFC 4122, ISO/IEC 9834-8:2005.'; 
COMMENT ON COLUMN omega_batch_tasks.batch_que_uuid 
IS 'batch_que_uuid - ';
COMMENT ON COLUMN omega_batch_tasks.agent 
IS 'agent - ';

COMMENT ON COLUMN omega_batch_tasks.task_nm 
IS 'task_nm - '; 
COMMENT ON COLUMN omega_batch_tasks.entity_src_uuid 
IS 'entity_src_uuid - '; 
COMMENT ON COLUMN omega_batch_tasks.activity 
IS 'activity - '; 
COMMENT ON COLUMN omega_batch_tasks.activity_parameters_uuid 
IS 'activity_parameters_uuid - '; 
COMMENT ON COLUMN omega_batch_tasks.entity_derived_uuid 
IS 'entity_derived_uuid - '; 
COMMENT ON COLUMN omega_batch_tasks.task_status 
IS 'task_status - '; 
COMMENT ON COLUMN omega_batch_tasks.task_prct_cmplt 
IS 'prct_cmplt - '; 
COMMENT ON COLUMN omega_batch_tasks.task_error_cnt 
IS 'task_error_cnt - '; 
COMMENT ON COLUMN omega_batch_tasks.task_start_datetime 
IS 'task_start_datetime - '; 
COMMENT ON COLUMN omega_batch_tasks.task_stop_datetime 
IS 'task_stop_datetime - '; 
COMMENT ON COLUMN omega_batch_tasks.task_message 
IS 'task_message - '; 
COMMENT ON COLUMN omega_batch_tasks.user_remarks 
IS 'user_remarks - '; 

COMMENT ON COLUMN omega_batch_tasks.status 
IS 'status - A 1 character code for the statsu of the record, (Current, Duplicate, Error, Historical, Logical, New, Processing, stionable, Ready to process, Waiting)'; 
COMMENT ON COLUMN omega_batch_tasks.status_by 
IS 'status_by - The user who last changed the status of the record';
COMMENT ON COLUMN omega_batch_tasks.status_date 
IS 'status_date - The date when the record status was last changed';

COMMENT ON COLUMN omega_batch_tasks.insert_date 
IS 'insert_date - The date the record was created';
COMMENT ON COLUMN omega_batch_tasks.insert_by 
IS 'insert_by - The user/fuction that created the record';
COMMENT ON COLUMN omega_batch_tasks.update_date 
IS 'update_date - The date the record was last modified';
COMMENT ON COLUMN omega_batch_tasks.update_by 
IS 'update_by - The user/function that last updated the record';
COMMENT ON COLUMN omega_batch_tasks.delete_flag 
IS 'delete_flag - A logical flag used to ignore the record as if it was deleted';   
COMMENT ON COLUMN omega_batch_tasks.delete_date 
IS 'delete_date - The date the logical delete flag was set';
COMMENT ON COLUMN omega_batch_tasks.delete_by 
IS 'delete_by - The user/function that set the logical delete flag';
COMMENT ON COLUMN omega_batch_tasks.hidden_flag 
IS 'hidden_flag - A flag used to hide/exclude the record from pick lists';  
COMMENT ON COLUMN omega_batch_tasks.hidden_date 
IS 'hidden_date - The date the hidden flag was set';
COMMENT ON COLUMN omega_batch_tasks.hidden_by 
IS 'hidden_by - The user/function that set the hidden flag';

/* Sourced from: http://schemas.opengis.net/ic/2.1/IC-ISM-v2.1.xsd            */
    
COMMENT ON COLUMN omega_batch_tasks.mandatorymetadata_security_c_0 
...
COMMENT ON COLUMN omega_batch_tasks.mandatorymetadata_security_c_2 
...
COMMENT ON COLUMN omega_batch_tasks.mandatorymetadata_security_c_1 
...
COMMENT ON COLUMN omega_batch_tasks.mandatorymetadata_security_d_7 
...
COMMENT ON COLUMN omega_batch_tasks.mandatorymetadata_security_d_6 
...
COMMENT ON COLUMN omega_batch_tasks.mandatorymetadata_security_d_3 
...
COMMENT ON COLUMN omega_batch_tasks.mandatorymetadata_security_d_4 
...
COMMENT ON COLUMN omega_batch_tasks.mandatorymetadata_security_d_5 
...
COMMENT ON COLUMN omega_batch_tasks.mandatorymetadata_security_d_1 
...
COMMENT ON COLUMN omega_batch_tasks.mandatorymetadata_security_d_2 
...
COMMENT ON COLUMN omega_batch_tasks.mandatorymetadata_security_d_0 
...
COMMENT ON COLUMN omega_batch_tasks.mandatorymetadata_security_f_0 
...
COMMENT ON COLUMN omega_batch_tasks.mandatorymetadata_security_o_0 
...
COMMENT ON COLUMN omega_batch_tasks.mandatorymetadata_security_r_0 
...
COMMENT ON COLUMN omega_batch_tasks.mandatorymetadata_security_s_1 
...
COMMENT ON COLUMN omega_batch_tasks.mandatorymetadata_security_s_0 
...
COMMENT ON COLUMN omega_batch_tasks.mandatorymetadata_security_t_0 
...
WHERE pc.relname = LOWER('omega_batch_tasks') AND pn.nspname = 'public';
*/
