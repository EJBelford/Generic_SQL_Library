/* Source File: fileobj.sql                                                   */
/*--+----1----+----2----+----3----+----4----+----5----+----6----+----7----+---*/
/*                                                                            */
/* Module Name: fileobj                                                       */
/*      Author: Gene Belford                                                  */
/* Description: The table contains the specific "FILE" information for the    */
/*              data object of a "FILE" type.  Examples od these would be     */
/*              size, location, name, etc.                                    */
/*        Date: 2014-02-26                                                    */
/*                                                                            */
/*--+----1----+----2----+----3----+----4----+----5----+----6----+----7----+---*/
/*                                                                            */
...
-- DROP TABLE IF EXISTS fileobj;

CREATE TABLE fileobj 
(
rec_id                          INTEGER       NOT NULL DEFAULT nextval('fileobj_seq'::regclass),
--
rec_uuid                        UUID          NOT NULL DEFAULT uuid_generate_v4(), 
dataobj_rec_uuid                UUID          NOT NULL, 
--
file_nm                         VARCHAR(255)  UNIQUE NOT NULL,
file_desc                       VARCHAR(2040) NOT NULL,
file_type_cd                    VARCHAR(254)  NOT NULL, 
file_retention_policy_cd        INT, 
storage_device                  VARCHAR(254)  NOT NULL,
...
COMMENT ON TABLE fileobj 
IS 'fileobj - The table contains the specific "FILE" information for the data object of a "FILE" type.  Examples od these would be size, location, name, etc.';

COMMENT ON COLUMN fileobj.rec_id 
...
COMMENT ON COLUMN fileobj.file_nm 
IS 'file_nm - ';
COMMENT ON COLUMN fileobj.file_desc 
IS 'file_desc - ';

COMMENT ON COLUMN fileobj.status 
...
COMMENT ON COLUMN fileobj.mandatorymetadata_security_c_2 
...
COMMENT ON COLUMN fileobj.mandatorymetadata_security_c_1 
...
COMMENT ON COLUMN fileobj.mandatorymetadata_security_d_7 
...
COMMENT ON COLUMN fileobj.mandatorymetadata_security_d_6 
...
COMMENT ON COLUMN fileobj.mandatorymetadata_security_d_3 
...
COMMENT ON COLUMN fileobj.mandatorymetadata_security_d_4 
...
COMMENT ON COLUMN fileobj.mandatorymetadata_security_d_5 
...
COMMENT ON COLUMN fileobj.mandatorymetadata_security_d_1 
...
COMMENT ON COLUMN fileobj.mandatorymetadata_security_d_2 
...
COMMENT ON COLUMN fileobj.mandatorymetadata_security_d_0 
...
COMMENT ON COLUMN fileobj.mandatorymetadata_security_f_0 
...
COMMENT ON COLUMN fileobj.mandatorymetadata_security_f_1 
...
COMMENT ON COLUMN fileobj.mandatorymetadata_security_n_0 
...
COMMENT ON COLUMN fileobj.mandatorymetadata_security_o_0 
...
COMMENT ON COLUMN fileobj.mandatorymetadata_security_r_0 
...
COMMENT ON COLUMN fileobj.mandatorymetadata_security_s_1 
...
COMMENT ON COLUMN fileobj.mandatorymetadata_security_s_0 
...
COMMENT ON COLUMN fileobj.mandatorymetadata_security_t_0 
...
WHERE pc.relname = LOWER('fileobj') AND pn.nspname = 'public';
*/
